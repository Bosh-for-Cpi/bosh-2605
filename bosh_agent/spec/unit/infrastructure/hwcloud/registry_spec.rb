...
Bosh::Agent::Infrastructure.new("hwcloud").infrastructure

describe Bosh::Agent::Infrastructure::Hwcloud::Registry do
  let(:user_data) {
    {
      "registry" => {
  ...
  describe :get_settings do
    ...
    it "should get settings from Bosh registry" do
      Bosh::Agent::Infrastructure::Hwcloud::Registry.stub(:get_registry_endpoint)
          .and_return("http://registry_endpoint")
      Bosh::Agent::Infrastructure::Hwcloud::Registry.should_receive(:get_server_name)
          .and_return("vm-name")
      Bosh::Agent::Infrastructure::Hwcloud::Registry.should_receive(:get_uri)
          .with("http://registry_endpoint/instances/vm-name/settings")
          .and_return(settings)

      settings = Bosh::Agent::Infrastructure::Hwcloud::Registry.get_settings
    ...
    it "should raise exception when response from Bosh registry is invalid" do
      ...
      expect {
        Bosh::Agent::Infrastructure::Hwcloud::Registry.get_settings
  ...
  describe :get_openssh_key do
    it "should get OpenSSH public key from HwCloud meta data" do
      Bosh::Agent::Infrastructure::Hwcloud::Registry.should_receive(:get_uri)
          .with("http://169.254.169.254/latest/meta-data/public-keys/0/openssh-key")
          .and_return("public openssh key")

      public_key = Bosh::Agent::Infrastructure::Hwcloud::Registry.get_openssh_key
    ...
    it "should get OpenSSH public key from injected user data file" do
      ...
      Bosh::Agent::Infrastructure::Hwcloud::Registry.stub(:get_user_data_from_file)
      Bosh::Agent::Infrastructure::Hwcloud::Registry.should_receive(:parse_user_data)
    ...
    it "should raise a LoadSettingsError exception when cannot get OpenSSH public key" do
      ...
      expect {
        Bosh::Agent::Infrastructure::Hwcloud::Registry.get_openssh_key
  ...
  describe :get_server_name do
    it "should get server name" do
      Bosh::Agent::Infrastructure::Hwcloud::Registry.should_receive(:get_user_data)
          .and_return(user_data)

      server_name = Bosh::Agent::Infrastructure::Hwcloud::Registry.get_server_name
    ...
    it "should raise a LoadSettingsError exception when cannot get server name" do
      ...
      expect {
        Bosh::Agent::Infrastructure::Hwcloud::Registry.get_server_name
      }.to raise_error Bosh::Agent::LoadSettingsError, /Cannot get HwCloud server name from user data/
    end
  end
  ...
  describe :get_registry_endpoint do
    it "should get Bosh registry endpoint" do
      ...
      registry_endpoint = Bosh::Agent::Infrastructure::Hwcloud::Registry.get_registry_endpoint
    ...
    it "should raise a LoadSettingsError exception when cannot get Bosh registry endpoint" do
      ...
      expect {
        Bosh::Agent::Infrastructure::Hwcloud::Registry.get_registry_endpoint
  ...
  describe :lookup_registry_endpoint do
    context "without dns nameservers" do
      it "should return Bosh registry endpoint" do
        registry_endpoint = Bosh::Agent::Infrastructure::Hwcloud::Registry.lookup_registry_endpoint(user_data)
        registry_endpoint.should == "http://registry_endpoint:25777"
      end
    end
    ...
    context "with dns nameservers" do
      ...
      it "should return Bosh registry endpoint as an IP address" do
        Bosh::Agent::Infrastructure::Hwcloud::Registry.should_receive(:lookup_registry_ip_address)
            .with("registry_endpoint", ["10.11.12.13", "14.15.16.17"])
            .and_return("4.3.2.1")

        registry_endpoint = Bosh::Agent::Infrastructure::Hwcloud::Registry.lookup_registry_endpoint(user_data_with_dns)
      ...
      it "should not lookup for an IP address when Bosh registry endpoint is an IP address" do
        ...
        Bosh::Agent::Infrastructure::Hwcloud::Registry.should_not_receive(:lookup_registry_ip_address)

        registry_endpoint = Bosh::Agent::Infrastructure::Hwcloud::Registry.lookup_registry_endpoint(user_data_with_ip)
      ...
      it "should raise a LoadSettingsError exception when cannot lookup the hostname" do
        ...
        expect {
          Bosh::Agent::Infrastructure::Hwcloud::Registry.lookup_registry_endpoint(user_data_with_dns)
  ...
  describe :get_user_data do
    context "first call" do
      before(:each) do
        Bosh::Agent::Infrastructure::Hwcloud::Registry.user_data = nil
      end

      it "should get user data from HwCloud user data" do
        Bosh::Agent::Infrastructure::Hwcloud::Registry.should_receive(:get_uri)
            .with("http://169.254.169.254/latest/user-data")
            .and_return(Yajl::Encoder.encode(user_data))

        hwcloud_user_data = Bosh::Agent::Infrastructure::Hwcloud::Registry.get_user_data
        hwcloud_user_data.should == user_data
      end
      ...
      it "should get user data from from injected user data file" do
        Bosh::Agent::Infrastructure::Hwcloud::Registry.should_receive(:get_uri)
            .with("http://169.254.169.254/latest/user-data")
            .and_raise Bosh::Agent::LoadSettingsError
        Bosh::Agent::Infrastructure::Hwcloud::Registry.should_receive(:get_user_data_from_file)
            .and_return(Yajl::Encoder.encode(user_data))
    ...
    context "next calls" do
      before(:each) do
        Bosh::Agent::Infrastructure::Hwcloud::Registry.user_data = user_data
      end

      it "should return previous user data" do
        Bosh::Agent::Infrastructure::Hwcloud::Registry.should_not_receive(:get_uri)
        hwcloud_user_data = Bosh::Agent::Infrastructure::Hwcloud::Registry.get_user_data
        hwcloud_user_data.should == user_data
      end
    end
  ...
  describe :get_user_data_from_file do
    it "should read injected user data file" do
      ...
      hwcloud_user_data = Bosh::Agent::Infrastructure::Hwcloud::Registry.get_user_data_from_file
      hwcloud_user_data.should == user_data
    end
    ...
    it "should raise a LoadSettingsError exception when cannot read injected user data file" do
      ...
      expect {
        Bosh::Agent::Infrastructure::Hwcloud::Registry.get_user_data_from_file
      }.to raise_error Bosh::Agent::LoadSettingsError, /Failed to get user data from Hwcloud injected user data file/
    end
  end

  describe :parse_user_data do
    it "should parse user data" do
      hwcloud_user_data = Bosh::Agent::Infrastructure::Hwcloud::Registry.parse_user_data(Yajl::Encoder.encode(user_data))
      hwcloud_user_data.should == user_data
    end

    it "should raise a LoadSettingsError exception when cannot parse user data" do
      expect {
        Bosh::Agent::Infrastructure::Hwcloud::Registry.parse_user_data("test")
    ...
    it "should raise a LoadSettingsError exception when user data is not a Hash" do
      expect {
        Bosh::Agent::Infrastructure::Hwcloud::Registry.parse_user_data("")
