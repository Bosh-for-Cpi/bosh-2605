  ...
  class BatDeploymentManifest
    ...
    def to_h
      manifest_hash = {
        'cpi' => 'hwcloud',
        'properties' => {
          'vip' => env['BOSH_HWCLOUD_VIP_BAT_IP'],
          'static_ip' => env['BOSH_HWCLOUD_STATIC_BAT_IP'],
          'second_static_ip' => env['BOSH_HWCLOUD_SECOND_STATIC_BAT_IP'],
          ...
          'instances' => 1,
          'key_name' => 'jenkins',
          'mbus' => "nats://nats:0b450ada9f830085e2cdeff6@#{env['BOSH_HWCLOUD_VIP_BAT_IP']}:4222",
          'network' => {
            'type' => net_type,
            'cloud_properties' => {
      ...
      if net_type == 'manual'
        manifest_hash['properties']['network'].merge!(
          'cidr' => env['BOSH_HWCLOUD_NETWORK_CIDR'],
          'reserved' => [env['BOSH_HWCLOUD_NETWORK_RESERVED']],
          'static' => [env['BOSH_HWCLOUD_NETWORK_STATIC']],
          'gateway' => env['BOSH_HWCLOUD_NETWORK_GATEWAY']
        )
      end
