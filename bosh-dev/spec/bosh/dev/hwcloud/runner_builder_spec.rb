...
require 'bosh/dev/hwcloud/runner_builder'

module Bosh::Dev::Hwcloud
  describe RunnerBuilder do
    describe '#build' do
      it 'returns hwcloud runner with injected env and proper director address' do
        ...
        class_double('Bosh::Dev::Bat::DirectorAddress').as_stubbed_const
          ...
          .with(ENV, 'BOSH_HWCLOUD_VIP_DIRECTOR_IP')
        ...
        microbosh_deployment_manifest = instance_double('Bosh::Dev::Hwcloud::MicroBoshDeploymentManifest')
        class_double('Bosh::Dev::Hwcloud::MicroBoshDeploymentManifest').as_stubbed_const
          .should_receive(:new)
          .with(ENV, 'net-type')
          .and_return(microbosh_deployment_manifest)

        microbosh_deployment_cleaner = instance_double('Bosh::Dev::Hwcloud::MicroBoshDeploymentCleaner')
        class_double('Bosh::Dev::Hwcloud::MicroBoshDeploymentCleaner').as_stubbed_const
          .should_receive(:new)
        ...
        bat_deployment_manifest = instance_double('Bosh::Dev::Hwcloud::BatDeploymentManifest')
        class_double('Bosh::Dev::Hwcloud::BatDeploymentManifest').as_stubbed_const
          .should_receive(:new)
