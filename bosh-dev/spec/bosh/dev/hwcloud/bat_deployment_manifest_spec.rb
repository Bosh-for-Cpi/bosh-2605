...
module Bosh::Dev::Hwcloud
  describe BatDeploymentManifest do
    ...
    describe '#to_h' do
      before do
        env.merge!(
          'BOSH_HWCLOUD_VIP_BAT_IP'       => 'vip',
          'BOSH_HWCLOUD_STATIC_BAT_IP'    => 'fake-static-ip',
          'BOSH_HWCLOUD_SECOND_STATIC_BAT_IP' => 'fake-second-static-ip',
          'BOSH_HWCLOUD_NET_ID'           => 'net_id',
          'BOSH_HWCLOUD_NETWORK_CIDR'     => 'net_cidr',
          'BOSH_HWCLOUD_NETWORK_RESERVED' => 'net_reserved',
          'BOSH_HWCLOUD_NETWORK_STATIC'   => 'net_static',
          'BOSH_HWCLOUD_NETWORK_GATEWAY'  => 'net_gateway',
        )
      end
