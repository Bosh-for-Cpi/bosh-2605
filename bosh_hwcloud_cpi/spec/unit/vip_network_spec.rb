...
describe Bosh::HwCloud::VipNetwork do
  let(:ec2) { double(HwCloud::EC2) }
  let(:instance) { double(HwCloud::EC2::Instance, :id => 'id') }
  ...
  it 'should retry to attach until it succeeds' do
    ...
    instance.should_receive(:associate_elastic_ip).and_raise(HwCloud::EC2::Errors::IncorrectInstanceState)
