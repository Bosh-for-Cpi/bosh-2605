  ...
  describe "#delete" do
    ...
    context "with real stemcell" do
      it "should deregister the ami" do
        ...
        Bosh::HwCloud::ResourceWait.stub(:for_image).with(image: fake_qingcloud_ami, state: :deleted)
    ...
    context "with light stemcell" do
      it "should fake ami deregistration" do
        ...
        fake_qingcloud_ami.should_receive(:deregister).and_raise(HwCloud::EC2::Errors::AuthFailure)
