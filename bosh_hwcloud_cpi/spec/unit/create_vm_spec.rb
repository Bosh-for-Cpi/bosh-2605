...
describe Bosh::HwCloud::Cloud, "create_vm" do
  ...
  before do
    ...
    Bosh::HwCloud::AvailabilityZoneSelector.
        stub(:new).
        with(region, "foo").
        and_return(availability_zone_selector)
    Bosh::HwCloud::Stemcell.
        stub(:find).
        with(region, stemcell_id).
        and_return(stemcell)
    Bosh::HwCloud::InstanceManager.
        stub(:new).
    ...
    instance_manager.
        ...
        and_return(instance)
    Bosh::HwCloud::NetworkConfigurator.
        stub(:new).
        with(networks_spec).
  ...
  it "should create an EC2 instance and return its id" do
    network_configurator.stub(:configure)
    registry.stub(:update_settings)
    Bosh::HwCloud::ResourceWait.stub(:for_instance).with(instance: instance, state: :running)
