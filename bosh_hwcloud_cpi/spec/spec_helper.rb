...
def make_cloud(options = nil)
  Bosh::HwCloud::Cloud.new(options || mock_cloud_options['properties'])
end
...
def mock_cloud(options = nil)
  ec2, region = mock_ec2
  HwCloud::EC2.stub(:new).and_return(ec2)
...
def mock_ec2
  region = double(HwCloud::EC2::Region)
  ec2 = double(HwCloud::EC2,
               :instances => double(HwCloud::EC2::InstanceCollection),
               :volumes => double(HwCloud::EC2::VolumeCollection),
               :images => double(HwCloud::EC2::ImageCollection),
               :regions => double(HwCloud::EC2::RegionCollection, :[] => region))
