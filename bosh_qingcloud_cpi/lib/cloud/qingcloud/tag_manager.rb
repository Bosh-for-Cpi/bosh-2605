module Bosh::QingCloud
  class TagManager
    ...
    # QingCloud limitation of 127 character key and 255 character value
    ...
    rescue QingCloud::EC2::Errors::InvalidParameterValue => e
      logger.error("could not tag #{taggable.id}: #{e.message}")
    rescue QingCloud::EC2::Errors::InvalidAMIID::NotFound,
        QingCloud::EC2::Errors::InvalidInstanceID::NotFound=> e
      # Due to the QingCloud eventual consistency, the taggable might not
